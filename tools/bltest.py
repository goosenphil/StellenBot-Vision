...
while(1):
    ...
    if blockVisible is False:
        ...
        if blockDist > height-110:
            gettingBlock = True
            if midw-100 < cx < midw+100:
                s.write( chr(101) + chr(0)  + chr(1) + chr(75) )
                s.write( chr(101) + chr(1)  + chr(1) + chr(75) )
            if midw+100 < cx:
                s.write( chr(101) + chr(0)  + chr(1) + chr(80) )
                s.write( chr(101) + chr(1)  + chr(1) + chr(70) )
            if midw-100 > cx:
                s.write( chr(101) + chr(0)  + chr(1) + chr(70) )
                s.write( chr(101) + chr(1)  + chr(1) + chr(80) )
            while gettingBlock:
                #Poll reed switch, true-> Rotate, seek beacon, goto beacon
                # Else, wait for 3000ms, stop if not found
                print "getting block"
                if checkMs(500): # Stop if block not found
                    print "Block lost--------------------------------"
                    s.write( chr(101) + chr(0)  + chr(1) + chr(0) )
                    s.write( chr(101) + chr(1)  + chr(1) + chr(0) )
                    gettingBlock = False
